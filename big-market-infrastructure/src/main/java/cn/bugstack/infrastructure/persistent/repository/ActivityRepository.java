...
public class ActivityRepository implements IActivityRepository {
    ...
    public void doSaveOrder(CreateQuotaOrderAggregate createQuotaOrderAggregate) {
        ...
        try {
            // 以用户ID为切分键，通过 doRouter 设定路由【这样就保证了下面的操作，都是同一个链接下，也就保证了事务的特性】
        ...
        try {
            ...
            transactionTemplate.execute(status -> {
                try {
                    ...
                    // 3. 更新日账户 true - 存在则更新，false - 不存在则插入
    ...
    @Override
    public ActivityAccountEntity queryRaffleActivityAccountByUserId(String userId, Long activityId) {
        // 1. 查询账户
    ...
    @Override
    public ActivityAccountMonthEntity queryRaffleActivityAccountMonthByUserId(String userId, Long activityId, String month) {
        // 1. 查询账户
    ...
    @Override
    public ActivityAccountDayEntity queryRaffleActivityAccountDayByUserId(String userId, Long activityId, String day) {
        // 1. 查询账户
    ...
    public List<ActivitySkuEntity> queryActivitySkuListByActivityId(Long activityId) {
        List<RaffleActivitySku> raffleActivitySkuList = raffleActivitySkuDao.queryActivitySkuListByActivityId();
    ...
    public Integer queryRaffleActivityAccountPartakeCount(String userId, Long activityId) {
        RaffleActivityAccount request = new RaffleActivityAccount();
        request.setUserId(userId);
        request.setActivityId(activityId);
    ...
    public UserRaffleOrderEntity queryNoUsedRaffleOrder(PartakeRaffleActivityEntity partakeRaffleActivityEntity) {
        ...
        userRaffleOrderEntity.setUserId(userRaffleOrderReq.getUserId());
