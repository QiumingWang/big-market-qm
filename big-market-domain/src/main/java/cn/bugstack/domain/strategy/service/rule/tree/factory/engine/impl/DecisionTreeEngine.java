...
public class DecisionTreeEngine implements IDecisionTreeEngine {
    ...
    @Override
    public DefaultTreeFactory.StrategyAwardVO process(String userId, Long strategyId, Integer awardId, Date expiredDate) {
        ...
        while (null != nextNode) {
            ...
            // 决策节点计算
            DefaultTreeFactory.TreeActionEntity logicEntity = logicTreeNode.logic(userId, strategyId, awardId, ruleValue, expiredDate);
