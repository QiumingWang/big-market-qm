...
public enum ResponseCode {
    ...
    STRATEGY_RULE_WEIGHT_IS_NULL("ERR_BIZ_001", "业务异常，策略规则中rule weight 权重规则以适用但没有配置"),
    UN_ASSEMBLED_STRATEGY_ARMORY("ERR_BIZ_002", "抽奖策略配置未装配，请通过IStrategyArmory完成装配"),
    ACTIVITY_STATE_ERROR("ERR_BIZ_003", "活动未开启(非open)状态"),
    ACTIVITY_DATE_ERROR("ERR_BIZ_004", "非活动抽奖日期"),
